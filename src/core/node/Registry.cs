...
/// <summary>
/// Registry is a simple dependency injection container for managing core services in the game. It allows registering and resolving services by their interface types.
/// </summary>
public class Registry
{
    ...
    {
        _objects[typeof(Tinterface)] = new TImplementation();
    ...
    {
        _objects.TryGetValue(typeof(T), out var core);
        if (core == null)
        {
